...
/* Picture bit-depth */
typedef enum { VP9ENC_8BIT = 0, VP9ENC_10BIT = 1 } VP9EncBitDepth;
...
typedef enum { VP9ENC_QM_PSNR = 0, VP9ENC_QM_SSIM = 1 } VP9EncQualityMetric;
...
typedef struct {
    ...
    u32 errorResilient; /* Enable error resilient stream mode. [0,1]
                         ...
                         * updates.                                 */
    u32 frameParallelDecodingMode; /* Enable frame parallel decodability
                                    * features. This prevents backward
                                    * adaptation of probabilities. */
    VP9EncQualityMetric qualityMetric; /* Setup encoding settings for
                                        * optimizing against defined quality
                                        * metrics */
...
typedef struct {
    ...
    u32 layerFrameRateDenom[4]; /* When temporal layers are enabled
                                 * defines the average frame rate denominator
                                 * for each layer. frameRateNum is used as time
                                 * scale for every layer. [1..frameRateNum] */
...
VP9EncRet VP9EncInit(const VP9EncConfig *pEncConfig, VP9EncInst *instAddr);
...
VP9EncRet VP9EncGetCodingCtrl(VP9EncInst inst, VP9EncCodingCtrl *pCodingParams);

/* Coding parameters which can be adjusted during encoding. */
VP9EncRet VP9EncSetRateCtrl(VP9EncInst inst, const VP9EncRateCtrl *pRateCtrl);
...
VP9EncRet VP9EncSetSegmentation(VP9EncInst inst, Vp9EncSegmentCtrl *info,
                                u32 sw_mixed_segment_penalty);
...
VP9EncRet VP9EncGetHwPerfCounter(VP9EncInst inst, HwPerfCounter *counters,
                                 u32 *counter_count);
#ifdef FPGA
VP9EncRet VP9EncGetHwTimePerFrame(VP9EncInst inst, i32 enc_index,
                                  float *time_use);
...
void VP9AXISet(VP9EncInst inst, u32 swap_input, i32 axi_rd_id, i32 axi_wr_id,
               u16 axi_rd_burst, u16 axi_wr_burst);
void VP9DECSet(VP9EncInst inst, i32 width, i32 height, i32 bitdepth,
               VP9EncIn *encIn, u32 lumaTable, u32 chromaTable,
               u32 inputCompress, i32 pass);
#ifndef USE_OLD_DRV
