...
typedef struct CWLHwConfig {
    u32 maxEncodedWidth; /* Maximum supported width for video encoding (not
                            JPEG) */
...
/* SW/HW shared memory */
i32 CWLMallocLinear(void *inst, u32 size, u32 direction, CWLLinearMem_t *info);
 ...
 * otherwise.
 */
void CWLRun(void *instance, size_t regs_size, void *job_regs, size_t num_jobs,
            enum CWLCoreStatus *status);
