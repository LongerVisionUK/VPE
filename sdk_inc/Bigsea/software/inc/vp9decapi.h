...
enum Vp9ColorSpace { VP9_YCbCr_BT601 = 0, VP9_CUSTOM, VP9_RGB = 7 };
...
struct Vp9DecPicture {
    ...
    size_t output_chroma_bus_address; /* Bus address of the chrominance
                                         component */
    unsigned char fc_modes[2][8]; /* Frame compression modes */
    u32 fc_num_tiles_col; /* Number of column tiles, needed to parse compression
                             info */
...
enum DecRet Vp9DecInit(Vp9DecInst *dec_inst, u32 use_video_freeze_concealment,
                       ...
                       enum DecPictureFormat output_format,
                       u32 disable_late_hw_sync, u32 use_reference_compression,
                       struct Vp9PpConfig pp_cfg, bool av1baseline);
