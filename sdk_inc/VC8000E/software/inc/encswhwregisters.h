...
#define ASIC_INPUT_I010                                                        \
    0x09 // yuv420 10 bit, in 16 bit pixel,  low 10bits valid, high 6 bits
         // invalid.
#define ASIC_INPUT_P010                                                        \
    0x0a // yuv420 10 bit, in 16 bit pixel,  high 10bits valid, low 6 bits
         // invalid.
...
------------------------------------------------------------------------------*/
static inline void EncAsicSetRegisterValue(u32 *regMirror, regName name,
                                           u32 value)
{
...
void EncAsicWriteRegisterValue(const void *ewl, u32 *regMirror, regName name,
                               u32 value);
