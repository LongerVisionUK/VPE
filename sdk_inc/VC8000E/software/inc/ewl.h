...
//    bit 30                 sw_enc_HWScalingSupport         Down-scaling
//    supported by HW. 0=not supported. 1=supported bit 29
//    sw_enc_HWBFrameSupport         HW bframe support. 0=not support bframe.
//    1=support bframe bit 28                 sw_enc_HWRgbSupport RGB to YUV
//    conversion supported by HW. 0=not supported. 1=supported bit 27
//    sw_enc_HWHevcSupport             HEVC encoding supported by HW. 0=not
//    supported. 1=supported bit 26                 sw_enc_HWVp9Support VP9
//    encoding supported by HW. 0=not supported. 1=supported bit 25
//    sw_enc_HWDenoiseSupport        Denoise supported by HW, 0=not supported.
//    1=supported bit [23:21]           sw_enc_HWBus                         Bus
//    connection of HW. 1=AHB. 2=OCP. 3=AXI. 4=PCI. 5=AXIAHB. 6=AXIAPB. bit 20
//    sw_enc_HWCavlcSupport            CAVLC supported by HW, 0=not supported.
//    1=supported bit 19                 sw_enc_HWLineBufSupport LineBuffer
//    input mode supported by HW, 0=not supported. 1=supported bit 18
//    sw_enc_HWProgRdoSupport       Prog Rdo supported by HW, 0=not supported.
//    1=supported bit 17                 sw_enc_HWRFCSupport Reference frame
//    compression supported by HW, 0=not supported. 1=supported bit 16
//    sw_enc_HWTU32Support            TU32 supported by HW, 0=not supported.
//    1=supported bit 15                 sw_enc_HWJPEGSupport           JPEG
//    encoder supported by HW, 0=not supported. 1=supported bit [14:13]
//    sw_enc_HWBusWidth                 Bus width of HW. 0=32b. 1=64b. 2=128b
//    bit [12:00]          sw_enc_HWMaxVideoWidth         Maximum video width
//    supported by HW (pixels)
typedef struct EWLHwConfig {
    ...
    u32 busType; /*bit 23:21 */ /* HW bus type in use  1=AHB. 2=OCP. 3=AXI.
                                   4=PCI. 5=AXIAHB. 6=AXIAPB.*/
    ...
    u32 maxEncodedWidthHEVC; /*bit 12:0 */ /* Maximum supported width for video
                                              encoding (HEVC mode on V62 and
                                              later) */
    ...
    u32 maxEncodedWidthH264; /*bit 25:13 */ /* Maximum supported width for video
                                               encoding (H264 mode) */
    u32 maxEncodedWidthJPEG; /*bit 12:0 */ /* Maximum supported width for video
                                              encoding (JPEG mode) */

    /* third part fuse in reg 226 */
    u32 ssimSupport; /*bit 31 */ /* HW supports SSIM calculation or not */
    u32 P010RefSupport; /*bit 30 */ /* HW supports P010 tile-raster format for
                                       reference frame buffer or not */
    u32 cuInforVersion; /*bit 29:27*/ /* Version of the output CU information
                                         format. */
    u32 meVertSearchRangeHEVC; /*bit 26:21*/ /*ME vertical search range in 8
                                                pixel unit for HEVC*/
    u32 meVertSearchRangeH264; /*bit 20:15*/ /*ME vertical search range in 8
                                                pixel unit for H264*/
    u32 ctbRcVersion; /*bit 14:12 */ /* CTB RC Version */
    u32 jpeg422Support; /*bit 11 */ /* HW supports JPEG422 coding or not */
    u32 gmvSupport; /*bit 10*/ /*Global MV supported by HW. 0=not supported.
                                  1=supported*/
    u32 ROI8Support; /*bit 9 */ /*8 ROIs supported by HW. 0=not supported.
                                   1=supported*/

    /* multi-pass features*/
    u32 meHorSearchRangeBframe; /* bit 8:7 */ /* ME4N horizontal search range in
                                                 64 pixel unit for BFrame (0: 64
                                                 pixel)*/
    u32 RDOQSupport; /* bit 6 */ /* HW support RDOQ or not */
    u32 bMultiPassSupport; /* bit 5 */ /* HW support multipass: 0=not supported.
                                          1=supoorted.*/
    u32 inLoopDSRatio; /* bit 4*/ /* HW support in-loop down scale: 0=1:1,
                                     1=1:2.*/
    u32 streamBufferChain; /* bit 3 */ /* Stream Buffer Chain supported by HW.
                                          0=not supported. 1=supported */
    u32 streamMultiSegment; /* bit 2 */ /* Stream multi-segment supported by HW.
                                           0=not supported. 1=supported */
    u32 IframeOnly; /* bit 1 */ /* Only I frame supported by HW. 0=I/P/B
                                   supported. 1=I only supported */
    u32 dynamicMaxTuSize; /* bit 0 */ /* Dynamic max TU size change per frame
                                         supported by HW. 0=not supported.
                                         1=supported */

    /* fourth part fuse in reg 287 */
    u32 videoHeightExt; /* bit 31*/ /* Maximum allowed video height extended
                                       from 8192 to 8640. 0=Not. 1=Yes. */
    u32 cscExtendSupport; /* bit 30*/ /* RGB to YUV conversion extension. 0=not
                                         supported. 1=supported*/
    u32 scaled420Support; /* bit 29*/ /* out-loop scaler output YUV420SP. 0=not
                                         supported. 1=supported*/
} EWLHwConfig_t;
...
i32 EWLWaitHwRdy(const void *inst, u32 *slicesReady, u32 totalsliceNumber,
                 u32 *status_register);
...
/* allocate loopback line buffer in memory, mainly used when there is no on-chip
 * sram */
...
i32 EWLMallocHostLinear(const void *instance, u32 size, u32 alignment,
                        EWLLinearMem_t *info);
#ifdef USE_OLD_DRV
...
#ifndef USE_OLD_DRV
i32 EWLMallocInoutLinear(const void *instance, u32 size, u32 alignment,
                         EWLLinearMem_t *info);
int EWLTransDataRC2EP(const void *instance, EWLLinearMem_t *src,
                      EWLLinearMem_t *dest, u32 size);
int EWLTransDataEP2RC(const void *instance, EWLLinearMem_t *src,
                      EWLLinearMem_t *dest, u32 size);
#endif
