...
typedef enum {
    JPEGENC_RGBTOYUV_BT601 = 0, /* Color conversion of limited range[16,235]
                                   according to BT.601 */
    JPEGENC_RGBTOYUV_BT709 = 1, /* Color conversion of limited range[16,235]
                                   according to BT.709 */
    ...
    JPEGENC_RGBTOYUV_BT601_FULL_RANGE = 4, /* Color conversion of full
                                              range[0,255] according to BT.601*/
    JPEGENC_RGBTOYUV_BT601_LIMITED_RANGE = 5, /* Color conversion of limited
                                                 range[0,219] according to
                                                 BT.601*/
    JPEGENC_RGBTOYUV_BT709_FULL_RANGE = 6 /* Color conversion of full
                                             range[0,255] according to BT.709*/
