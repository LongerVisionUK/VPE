...
struct pps {
    ...
    true_e transform8x8Mode; /*H264 8x8 tranform, 0:1 disable/enable 8x8
                                transform*/
};
...
void init_poc_list(struct rps *r, i32 poc, bool is_ltr_cur, u32 codingType,
                   struct container *c, bool bH264, const bool *pLTR_used);
...
void VCEncSpsSetVuiTimigInfo(struct sps *sps, u32 timeScale,
                             u32 numUnitsInTick);
...
void VCEncSpsSetVuiSignalType(struct sps *sps, u32 VideoSignalTypePresentFlag,
                              u32 video_format, u32 videoFullRange,
                              u32 ColorDescripPresentFlag, u32 ColorPrimaries,
                              u32 TransferCharacteristics,
                              u32 MatrixCoefficients);
...
void H264AccessUnitDelimiter(struct buffer *b, u32 byte_stream,
                             u32 primary_pic_type);
