...
void H264ScalabilityInfoSei(struct buffer *sp, struct sps *s, i32 svctLevel,
                            i32 frameRate);

void HevcUpdateSeiMasteringDisplayColour(sei_s *sei,
                                         Hdr10DisplaySei *pDisplaySei);
void HevcMasteringDisplayColourSei(struct buffer *sp, sei_s *sei);
void HevcUpdateSeiContentLightLevelInfo(sei_s *sei,
                                        Hdr10LightLevelSei *pLightSei);
