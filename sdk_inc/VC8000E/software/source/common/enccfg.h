...
/* Burst length. This sets the maximum length of a single ASIC burst in
 * addresses. Allowed values are: AHB {0, 4, 8, 16} ( 0 means incremental burst
 * type INCR) OCP [1,63] AXI [1,16]
 */
...
#define ENCH2_AXI40_BURST_LENGTH 0x40
#else
