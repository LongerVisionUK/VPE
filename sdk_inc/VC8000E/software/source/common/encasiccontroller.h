...
#define ASIC_FRAME_BUF_CUINFO_MAX                                              \
    (X265_LOOKAHEAD_MAX + X265_BFRAME_MAX + MAX_CORE_NUM - 1)
...
typedef struct {
    ...
    EWLLinearMem_t dec400CacheStatusLuma[ASIC_FRAME_BUF_LUM_MAX];
#endif
    ...
    u32 sizeTblSize;
    EWLLinearMem_t sizeTbl[MAX_CORE_NUM];
    EWLLinearMem_t compress_coeff_SACN[MAX_CORE_NUM];
