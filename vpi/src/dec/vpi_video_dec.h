...
struct VpiDecWrapper {
    ...
    VpiRet (*get_buffer_info)(VpiDecInst inst, struct DecBufferInfo *buf_info);
    VpiRet (*add_buffer)(VpiDecInst inst, struct DWLLinearMem *buf);
#endif
...
typedef struct VpiDecCtx {
    ...
    pthread_mutex_t ext_buffer_ctrl;
